...
export const skillText = [
    ...
    {
        title: "새로운 언어와의 만남",
        desc:  "프로그래밍 언어는 나에게 새로운 세계의 문을 여는 열쇠였습니다. 처음에는 이해하기 어려웠지만, 한 줄 한 줄 코드를 작성할 때마다 마치 새로운 언어를 배우는 것처럼 두근거렸습니다. 그 과정에서 작은 성취감이 쌓이며, 나는 점점 더 자신감을 얻게 되었습니다."
    },
    {
        title: "첫 프로젝트의 설렘",
        desc:  "첫 웹사이트를 만들 때의 설렘은 아직도 잊을 수 없습니다. 모든 것이 낯선 환경에서 팀원들과 함께 도전해봤지만 모든 것이 낯설었던 저희는 프로젝트를 완벽하게 해내지 못했습니다. 팀 프로젝트를 하면서 부족했던 부분들에 대해 생각해볼 수 있었고, 그걸 기반으로 성장해 나아갈 수 있었습니다."
    },    
    {
        title: "끝없는 학습의 즐거움",
        desc:  "개발 분야는 항상 변화하고 있기에, 매일 새로운 것을 배우는 즐거움은 나의 동기부여가 되었습니다. 새로운 기술을 익히고, 최신 트렌드를 따라가는 과정에서 나는 끊임없이 성장하고 있습니다. 이 여정에서 느끼는 희열은 나의 꿈을 더욱 굳건히 만들어줍니다."
    }
]
